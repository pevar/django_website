...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'news_news', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'news_news_owner_related', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'News.changed_by'
        db.add_column(u'news_news', 'changed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'news_news_changed_by_related', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'News.creation_date'
        db.add_column(u'news_news', 'creation_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 5, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'News.changed_date'
        db.add_column(u'news_news', 'changed_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 3, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.created_by'
        db.delete_column(u'news_news', 'created_by_id')

        # Deleting field 'News.changed_by'
        db.delete_column(u'news_news', 'changed_by_id')

        # Deleting field 'News.creation_date'
        db.delete_column(u'news_news', 'creation_date')

        # Deleting field 'News.changed_date'
        db.delete_column(u'news_news', 'changed_date')
    ...
    models = {
        ...
        u'news.news': {
            ...
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'news_news_changed_by_related'", 'to': u"orm['auth.User']"}),
            'changed_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'news_news_owner_related'", 'to': u"orm['auth.User']"}),
            ...
            'sites': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "u'news_news_related'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['sites.Site']"}),
            ...
            'visible_en': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'visible_it': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'sites.site': {
