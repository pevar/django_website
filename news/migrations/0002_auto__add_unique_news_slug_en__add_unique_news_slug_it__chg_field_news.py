...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'News', fields ['slug_en']
        db.create_unique(u'news_news', ['slug_en'])

        # Adding unique constraint on 'News', fields ['slug_it']
        db.create_unique(u'news_news', ['slug_it'])


        # Changing field 'News.slug'
        db.alter_column(u'news_news', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), populate_from='title', max_length=50, unique=True))
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'News', fields ['slug_it']
        db.delete_unique(u'news_news', ['slug_it'])

        # Removing unique constraint on 'News', fields ['slug_en']
        db.delete_unique(u'news_news', ['slug_en'])


        # Changing field 'News.slug'
        db.alter_column(u'news_news', 'slug', self.gf('autoslug.fields.AutoSlugField')(populate_from='title', unique_with=(), max_length=50, null=True))
    ...
    models = {
        ...
        u'news.news': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique': 'True', 'max_length': '50', 'populate_from': "'title'", 'unique_with': '()', 'blank': 'True'}),
